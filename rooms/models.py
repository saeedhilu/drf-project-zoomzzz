...
class City(models.Model):
    name = models.CharField(max_length=50, unique=False)  # Ensure unique city names
...
class Location(models.Model):
    ...
    country = models.CharField(max_length=50, blank=True, null=True)  # Optional country field
